...
test_data = data[3600000:3700000]
...
nbrs = NearestNeighbors(n_neighbors=3, algorithm='auto').fit(df)
...
for i in range(0, len(classes2)):
	if(predicted_class[i] == 'NQSO' and classes2[3600000+i]!= 'QSO'):
		tn += 1
	elif(predicted_class[i] == 'QSO' and classes2[3600000+i]== 'QSO'):
		tp += 1
	elif(predicted_class[i] == 'NQSO' and classes2[3600000+i]== 'QSO'):
		fn += 1
	else:
		fp += 1
print ''
