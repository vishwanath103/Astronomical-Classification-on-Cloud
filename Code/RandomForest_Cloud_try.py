...
trainingFile = "Training_Data.csv"
...
#resultList.saveAsTextFile("gs://vishu/RandomForesrTestResult")
print resultList.take(5)
resultList.saveAsTextFile("/media/vishwanath/Vishwanath/IIITB/Sem_2/PE/Spark/RandomForestResults")
